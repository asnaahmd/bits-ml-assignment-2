...
- **Total Instances**: 2,000 samples (Test dataset partition: 400 samples) — _Exceeds minimum requirement of 500 instances_
- **Total Features**: 16 input features + 1 target variable — _Exceeds minimum requirement of 12 features_
...
- **GitHub Repository**: `https://github.com/asnaahmd/bits-ml-assignment-2`
- **Live Streamlit App**: `https://bits-ml-assignment-2-kmxvwtdayhbc9qmgmksnqw.streamlit.app/`
